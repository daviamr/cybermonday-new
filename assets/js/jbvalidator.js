! function(e) {
    ...
    e.fn.jbvalidator = function(t) {
        ...
        let l = 0;
        t.language && e.getJSON(t.language, (function(e) {
            i = e
        ...
        let r = function(t, i) {
                let r = i || "";
                return l = 0, e(t || a).find(n).each(((e, t) => {
                    o(t, r)
                })), l
            },
            s = function() {
                e(a).find(n).each(((t, a) => {
                    e(a).off("input"), e(a).on("input", (function(t) {
            ...
            o = function(e, a) {
                e.setCustomValidity(""), !1 !== e.checkValidity() ? Object.values(f).map((t => {
                    let i = t.call(t, e, a);
                    i && e.setCustomValidity(i)
                })) : t.html5BrowserDefault || e.setCustomValidity(d(e)), !1 === e.checkValidity() ? (u(e, e.validationMessage), l++) : c(e)
            },
            u = function(a, i) {
            ...
            f = {
                ...
                groupCheckBox: function(t, a) {
                    if (p(t, "type", "checkbox")) {
                        ...
                        if (n && (void 0 !== a.originalEvent && "input" === a.originalEvent.type && e(n).find("input[type=checkbox]").each(((t, a) => {
                                e(a).trigger("input")
                            })), r < l && (s || r > 0) && !1 === e(t).prop("checked"))) return i.groupCheckBox.sprintf(l)
                    }
                    return ""
                },
        ...
        return String.prototype.sprintf = function() {
